...
void displayMenu() {
    ...
    std::cout << "4. Search for speakers by topic\n";
    std::cout << "5. Exit\n";
    std::cout << "------------------------\n";
}
...
void searchSpeakersByTopic(const Speaker speakers[], int speakerCount, const std::string& keyword) {
    bool found = false;
    ...
    if (!found) {
        std::cout << "No speakers found for the specified topic.\n";
    }
}
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 4: {
                std::string keyword;
                std::cout << "Enter a keyword to search for speakers by topic: ";
                std::cin >> keyword;
